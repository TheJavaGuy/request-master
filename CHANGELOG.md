...
- [#12](https://github.com/TheJavaGuy/request-master/pull/12) update http-signature to 1.3.5 (@TheJavaGuy)
- [#10](https://github.com/TheJavaGuy/request-master/pull/10) add node.js v12 to TravisCI (@TheJavaGuy)
- [#7](https://github.com/TheJavaGuy/request-master/pull/7) switch from standard to semistandard (@TheJavaGuy)
- [#4](https://github.com/TheJavaGuy/request-master/pull/4) update har-validator to 5.1.5 (@TheJavaGuy)
- [#3268](https://github.com/request/request/pull/3268) README: typo in deprecation message (#3268) (@gr2m)
- [#3267](https://github.com/request/request/pull/3267) doc: note full deprecation (#3267) (@mikeal)
- [#3169](https://github.com/request/request/pull/3169) Use nyc instead of istanbul (#3169) (@andresroberto)
- [#3023](https://github.com/request/request/pull/3023) Update README.md (#3023) (@odykyi)
- [#3008](https://github.com/request/request/pull/3008) docs: :memo: Updated the Change Log for v2.88.0 (2018/08/10) (#3008) (@shige)
- [#3115](https://github.com/request/request/pull/3115) docs: adjust readme timeout argument description to be clearer (#3115) (@jaredsuttles)
- [#3109](https://github.com/request/request/pull/3109) Update outdated link in comment (#3109) (@flotwig)
- [#3090](https://github.com/request/request/pull/3090) fix: Clear timeout on `#abort()` (#3090) (@reconbot)
- [#3089](https://github.com/request/request/pull/3089) chore: Update to tough-cookie 2.5.0 (#3089) (@grabus)
- [#2972](https://github.com/request/request/pull/2972) optimize:do unnecessary processing when changing options to null (#2972) (@rickyes)
- [#3074](https://github.com/request/request/pull/3074) fix: expression minor bugs (#3074) (@A1vinSmith)
- [#2808](https://github.com/request/request/pull/2808) Revert "Workaround for GitHub issue #2807 (#2808)" (#3075) (@reconbot)
- [#2808](https://github.com/request/request/pull/2808) Workaround for GitHub issue #2807 (#2808) (@pgonzal)
- [#3064](https://github.com/request/request/pull/3064) chore: ensure piped body is exactly the same (#3064) (@reconbot)
- [#3046](https://github.com/request/request/pull/3046) fix: use const instead of var in the README (#3046) (@EmmanuelDemey)
- [#2995](https://github.com/request/request/pull/2995) Documented response.caseless.get() (#2995) (@lifeisfoo)
- [#2701](https://github.com/request/request/pull/2701) Verify that body is not empty (#2701) (@RolfKoenders)
- [#2728](https://github.com/request/request/pull/2728) Update the documentation of timeout to reflect it controls timeout of socket inactivity (#2728) (@odedpeer)
- [#2750](https://github.com/request/request/pull/2750) Update cookie store API link (#2750) (@Huachao)
- [#2824](https://github.com/request/request/pull/2824) Update README to mention util.promisify() (#2824) (@riverspirit)
- [#2674](https://github.com/request/request/pull/2674) Fix link to HAR 1.2 Section Anchor (#2674) (@Maciek416)
- [#2644](https://github.com/request/request/pull/2644) Update README.md (#2644) (@deed02392)
- [#3062](https://github.com/request/request/pull/3062) fix: SSL Certs (#3062) (@reconbot)
- [#3061](https://github.com/request/request/pull/3061) Add neverstale label to stalebot config (@reconbot)
- [#3060](https://github.com/request/request/pull/3060) chore: Add probot-stale (@reconbot)
- [#3055](https://github.com/request/request/pull/3055) fix #3054, Bump har-validator version to 5.1.3 (#3055) (@JChanceHud)
